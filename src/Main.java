...
public class Main {
	...
	public static void main(String[] args) {
		...
		Usuario usuario = new Usuario("admin", "1234", null, null);
		Usuario usuario2 = new Usuario("cliente", "1234", cliente, null);
		Usuario usuario3 = new Usuario("cliente2", "1234", cliente2, null);
		Usuario usuario4 = new Usuario("empresa", "1234", null, empresa);
		Usuario usuario5 = new Usuario("empresa2", "1234", null, empresa2);
		Usuario usuario6 = new Usuario("empresa3", "1234", null, empresa3);

		List<Usuario> usuarios = Arrays.asList(usuario, usuario2, usuario3, usuario4, usuario5, usuario6);
